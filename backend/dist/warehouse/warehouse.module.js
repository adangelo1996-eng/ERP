...
exports.WarehouseModule = WarehouseModule = __decorate([
    (0, common_1.Module)({
        imports: [
            typeorm_1.TypeOrmModule.forFeature([warehouse_entity_1.Warehouse, location_entity_1.Location, stock_entity_1.StockItem, stock_movement_entity_1.StockMovement]),
        ],
