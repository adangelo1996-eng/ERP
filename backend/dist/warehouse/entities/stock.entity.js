...
let StockItem = class StockItem extends base_entity_1.BaseEntityWithTenant {
    location;
    itemId;
    batch;
    quantity;
...
], StockItem.prototype, "location", void 0);
__decorate([
    (0, typeorm_1.Column)({ type: 'varchar', length: 64 }),
    __metadata("design:type", String)
], StockItem.prototype, "itemId", void 0);
__decorate([
    (0, typeorm_1.Column)({ type: 'varchar', length: 64, nullable: true }),
    __metadata("design:type", String)
], StockItem.prototype, "batch", void 0);
__decorate([
...
exports.StockItem = StockItem = __decorate([
    (0, typeorm_1.Entity)({ name: 'wh_stock' })
], StockItem);
