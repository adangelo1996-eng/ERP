...
let WorkCenter = class WorkCenter extends base_entity_1.BaseEntityWithTenant {
    code;
    name;
    capacity;
};
...
__decorate([
    ...
    __metadata("design:type", String)
], WorkCenter.prototype, "name", void 0);
__decorate([
    (0, typeorm_1.Column)({ type: 'numeric', precision: 10, scale: 2, default: 1 }),
    __metadata("design:type", String)
], WorkCenter.prototype, "capacity", void 0);
exports.WorkCenter = WorkCenter = __decorate([
    (0, typeorm_1.Entity)({ name: 'prod_work_centers' })
], WorkCenter);
//# sourceMappingURL=work-center.entity.js.map