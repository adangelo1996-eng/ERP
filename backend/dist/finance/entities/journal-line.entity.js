...
let JournalLine = class JournalLine extends base_entity_1.BaseEntityWithTenant {
    entry;
    account;
    debit;
    credit;
...
__decorate([
    (0, typeorm_1.ManyToOne)(() => journal_entry_entity_1.JournalEntry, (entry) => entry.lines, { nullable: false }),
    __metadata("design:type", journal_entry_entity_1.JournalEntry)
], JournalLine.prototype, "entry", void 0);
__decorate([
    (0, typeorm_1.ManyToOne)(() => account_entity_1.Account, { nullable: false }),
...
exports.JournalLine = JournalLine = __decorate([
    (0, typeorm_1.Entity)({ name: 'fin_journal_lines' })
], JournalLine);
